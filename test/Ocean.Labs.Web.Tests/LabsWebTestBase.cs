...
{
    public abstract class LabsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LabsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LabsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LabsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LabsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LabsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LabsDbContext, Task<T>> func)
        {
            T result;
